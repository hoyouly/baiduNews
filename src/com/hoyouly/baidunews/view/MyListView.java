...
public class MyListView extends ListView implements OnScrollListener {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			mLastY = ev.getRawY();
			if (!mPullRefreshing && getFirstVisiblePosition() == 0 && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)) {
	...
	/**
	 * start refresh 不调用mListViewListener.onRefresh()
	 */
