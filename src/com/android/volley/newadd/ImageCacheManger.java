...
public class ImageCacheManger {
	 ...
	 */
	public static ImageLoader.ImageContainer loadImage(final String url, final ImageView view, final Bitmap defaultImageBitmap, final Bitmap errorImageBitmap) {
	 ...
	 * @param maxHeight
	 */
	public static ImageLoader.ImageContainer loadImage(final String url, final ImageView view, final Bitmap defaultImageBitmap, final Bitmap errorImageBitmap, int maxWidtn, int maxHeight) {
		return loadImage(url, getImageLinseter(view, defaultImageBitmap, errorImageBitmap), maxWidtn, maxHeight);
	}

	public static ImageLoader.ImageContainer loadImage(final String url, final ImageView view, final int defaultImageResId, final int errorImageResId, int maxWidtn, int maxHeight) {
		return loadImage(url, ImageLoader.getImageListener(view, defaultImageResId, errorImageResId), maxWidtn, maxHeight);
	}
